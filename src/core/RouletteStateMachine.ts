...
export class RouletteStateMachine extends EventEmitter {
  ...
  // ====== Flags/condiciones internas ======
  private autoTimer = false;
  private spinComplete = false;
  private mode: 'manual' | 'auto' = 'auto'; // dejamos la firma por compatibilidad externa
  ...
  // Modo (mantener API pública; internamente solo usamos 'auto')
